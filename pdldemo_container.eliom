  ...
  Lwt.return (
    header ~a:[a_class ["os-page-header"]]
      [ a ~a:[a_class ["os-page-header-app-name"]]
          ...
          [ pcdata Pdldemo_base.displayed_app_name ]
          ()
      ; user_box
      ]
  )
...
let%shared os_footer () = Eliom_content.Html.F.(
  footer ~a:[a_class ["os-page-footer"]] [
    p [
      ...
      a ~service:Pdldemo_services.os_github_service
        [ pcdata " Ocsigen Start " ] ();
      pcdata [%i18n S.footer_eliom_distillery];
      a ~service:Pdldemo_services.ocsigen_service
        [ pcdata " Ocsigen " ] ();
