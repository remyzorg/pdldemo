    ...
    [
      div ~a:[a_class ["os-settings"]] [
        ...
        Os_user_view.upload_pic_link
          ...
          Pdldemo_services.upload_user_avatar_service;
        br ();
